...
const FloatingNavbar = () => {
  ...
  const navItems = [
    { path: '/', label: 'AI Agent', icon: Rocket },
    { path: '/home#our-story', label: 'Our Story', icon: BookOpen },
    { path: '/home#services', label: 'Services', icon: Settings },
    { path: '/home#pricing', label: 'Pricing', icon: Briefcase },
