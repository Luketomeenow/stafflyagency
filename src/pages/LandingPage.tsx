    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-white">
      <div className="relative">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50 to-indigo-50">
          {/* Subtle Background Elements (no circular blur) */}
          ...
          <div className="container-wide relative z-15 pt-20 pb-10">
            <div className="max-w-10xl mx-auto text-center">
              ...
              >
                ...
                >
                  Get qualified <span className="text-slate-800 font-semibold">A+ VA profiles</span> in the palm of your hand by chatting with{' '}
                  <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-bold">Staffly AI</span>
                </motion.p>
                ...
                >
                  <div className="flex justify-center w-full">
                    <div className="w-full max-w-6xl" style={{ 
                      background: 'radial-gradient(ellipse 1000px 800px at 50% 50%, rgba(59, 130, 246, 0.3) 0%, rgba(37, 99, 235, 0.2) 40%, transparent 70%)',
                      padding: '120px 0',
                      filter: 'blur(0px)',
                    }}>
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Elite virtual assistants designed to scale your business with precision and expertise
              </p>
            </motion.div>
              ...
              services={[
                {
                  ...
                  outcome: "Elite talent that drives results",
                  description: "World-class virtual assistants and operators",
                  icon: "👥",
                  color: "from-blue-500 to-blue-600",
                  bgColor: "from-blue-50 to-blue-100",
                  borderColor: "border-blue-200",
                  features: [
                    "Pre-vetted A+ operators with proven track records",
                    "Executive assistants, project coordinators, and specialists",
                    "Curated shortlists with PCE scoring (Preparation, Capability, Execution)",
                    "Ongoing account management and quality assurance"
                  ]
                },
                {
                  title: "AI Adoption",
                  outcome: "Amplify your team with intelligent automation",
                  description: "AI-powered tools and workflow optimization",
                  icon: "🤖",
                  color: "from-violet-500 to-violet-600",
                  bgColor: "from-violet-50 to-violet-100",
                  borderColor: "border-violet-200",
                  features: [
                    "AI chatbot integration for customer support and lead qualification",
                    "Workflow automation and process optimization",
                    "Custom AI solutions tailored to your business needs",
                    "Training and implementation support for your team"
                  ]
                },
                {
                  title: "Website Solutions",
                  outcome: "Professional web presence that converts",
                  ...
                  features: [
                    ...
                    "Fast loading speeds and modern UI/UX",
                    "Content management systems for easy updates"
                  ]
                },
                {
                  title: "Webapp Customization",
                  outcome: "Tailored software that fits your workflow",
                  description: "Custom web applications and integrations",
                  icon: "⚙️",
            ...
            >
              <h3 className="text-3xl font-bold text-slate-900 mb-8 text-center">Feature Highlights</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-2">AI-Powered Matching</h4>
                      <p className="text-slate-600">Chat with Staffly AI to get curated A+ operator profiles instantly matched to your needs</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-2">Vetted Talent Pool</h4>
                      <p className="text-slate-600">Every operator is rigorously screened with PCE scoring (Preparation, Capability, Execution)</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-2">Full-Stack Solutions</h4>
                      <p className="text-slate-600">From skilled operators to AI adoption, websites, and custom web apps—we've got you covered</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">Dedicated account management with early micro-observations and monthly performance reviews</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-2">Flexible Pricing</h4>
                      <p className="text-slate-600">Four tiers from Support to Enterprise Operator—scale as you grow with transparent pricing</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-sm">6</div>
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-2">Excellence-First Culture</h4>
                      <p className="text-slate-600">We optimize for quality and reliability—no "cheapest wins" approach, only A+ talent</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="pricing" className="section bg-gradient-to-br from-slate-50 via-white to-blue-50 relative overflow-hidden">
          ...
          <div className="container relative z-10">
            ...
            <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-8 max-w-7xl mx-auto">
              ...
              >
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Support Operator</h3>
                  <p className="text-slate-600 text-sm mb-6 leading-relaxed">Early-stage solopreneurs or small business owners</p>
                  <div className="text-4xl font-black text-slate-900 mb-2">$1,200-$1,500</div>
                  <div className="text-slate-600 font-medium">USD/mo</div>
                </div>
                <div className="mb-8">
                  <p className="text-slate-700 leading-relaxed">Removes daily admin noise so founders can focus on growth</p>
                </div>
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-6 rounded-full hover:shadow-lg transition-all duration-300">
                  Get Started
                </button>
              </motion.div>

              {/* Essential Administrative Operator */}
              <motion.div
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
              ...
              >
                ...
                <div className="mb-8 pt-6">
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Essential</h3>
                  <p className="text-slate-600 text-sm mb-6 leading-relaxed">Entrepreneurs with consistent client work and systems</p>
                  <div className="text-4xl font-black text-slate-900 mb-2">$1,800-$2,000</div>
                  <div className="text-slate-600 font-medium">USD/mo</div>
                </div>
                <div className="mb-8">
                  <p className="text-slate-700 leading-relaxed">Maintains order, communication, and consistency across admin + marketing</p>
                </div>
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-6 rounded-full hover:shadow-lg transition-all duration-300">
                  Get Started
                </button>
              ...
              >
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Executive Operator</h3>
                  <p className="text-slate-600 text-sm mb-6 leading-relaxed">Established founders managing teams or multiple revenue streams</p>
                  <div className="text-4xl font-black text-slate-900 mb-2">$2,500-$3,000</div>
                  <div className="text-slate-600 font-medium">USD/mo</div>
                </div>
                <div className="mb-8">
                  <p className="text-slate-700 leading-relaxed">A proactive right-hand operator who drives structure, reporting, and accountability</p>
                </div>
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-6 rounded-full hover:shadow-lg transition-all duration-300">
                  Get Started
                </button>
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.4 }}
                viewport={{ once: true }}
                className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-purple-400/40 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] group"
              >
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Enterprise Operator</h3>
                  <p className="text-slate-600 text-sm mb-6 leading-relaxed">Founders with multiple departments or teams</p>
                  <div className="text-4xl font-black text-slate-900 mb-2">$4,500-$5,000</div>
                  <div className="text-slate-600 font-medium">USD/mo</div>
                </div>
                <div className="mb-8">
                  <p className="text-slate-700 leading-relaxed">Acts as Chief of Staff—leads assistants, manages budgets, and drives execution</p>
                </div>
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-6 rounded-full hover:shadow-lg transition-all duration-300">
                  Get Started
                </button>
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <div className="text-center mb-10">
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed max-w-4xl mx-auto">
                      Staffly is a platform that connects businesses with virtual assistants. While we strive to provide high-quality services and carefully vet our virtual assistants, we cannot guarantee specific outcomes or results.
                    </p>
                  </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-slate-600 text-sm leading-relaxed">
                            High-quality virtual assistant profiles, comprehensive vetting, and ongoing support for successful partnerships.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-6 border border-blue-500/20">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        The success of any virtual assistant relationship depends on clear communication, proper training, ongoing management, and collaborative effort between your business and the virtual assistant.
                      </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-2xl p-6 border border-green-500/20">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        We strongly recommend providing clear expectations, proper onboarding, and ongoing feedback to maximize the effectiveness of your virtual assistant partnerships.
                      </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-2xl p-6 border border-orange-500/20">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Virtual assistants are independent contractors. Staffly is not responsible for their actions, performance, or conduct, as they operate independently from our platform.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="text-center pt-6 border-t border-slate-200">
                    <p className="text-slate-700 leading-relaxed">
                      By using our services, you acknowledge that you understand these terms and agree to work collaboratively with your virtual assistant to achieve your business goals.
                    </p>
          ...
          <div className="container relative z-10">
            ...
            <div className="grid lg:grid-cols-4 gap-12 py-20">
              ...
              <div className="lg:col-span-2">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-slate-900">Staffly</h3>
                      <p className="text-blue-600 text-sm">Elite Virtual Assistants</p>
                    </div>
                  </div>
                  <p className="text-slate-600 mb-6 max-w-md leading-relaxed">
                    Transform your business with A+ virtual assistants. We connect you with elite talent that thinks like you do.
                  </p>
              ...
              <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                ...
                <div className="text-center md:text-right">
                  <p className="text-slate-500 text-sm mb-2">
                    &copy; 2025 Staffly. All rights reserved.
                  </p>
