...
const ServicesPage = () => {
  ...
  const services = [
    {
      ...
      subtitle: 'Virtual & Executive Assistants',
      description: 'Access to a curated pool of 20,000+ pre-vetted Filipino professionals across all industries and skill levels.',
      features: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      {/* Header Section - align visual design with homepage */}
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Services Grid - match card styling from homepage sections */}
          <div className="grid lg:grid-cols-2 gap-8 mb-20">
            {services.map((service, index) => (
              <motion.div key={index} variants={fadeInUp}>
                <MagneticCard>
                  <GlassCard className={`p-8 rounded-3xl h-full bg-white/80 backdrop-blur-xl border border-slate-200/60 shadow-xl ${service.glow}`}>
          ...
          {/* Process Section - use same palette */}
          ...
          {/* CTA Section - gradient like homepage CTAs */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto">
          <motion.div variants={fadeInUp} className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose Staffly Agency?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
