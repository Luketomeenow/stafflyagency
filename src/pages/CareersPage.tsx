...
import { Briefcase, MapPin, Clock, DollarSign, ArrowRight, Users, Zap, Heart, TrendingUp, Award, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50 to-indigo-50">
        ...
        <div className="container-wide relative z-15 pt-32 pb-20">
          <motion.div
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center px-4 py-2 bg-blue-100/50 text-blue-700 text-sm font-semibold rounded-full mb-6 border border-blue-200/50">
              <Briefcase className="w-4 h-4 mr-2" />
              Join Our Team
            </motion.div>

            <motion.h1 variants={fadeInUp} className="text-6xl lg:text-7xl font-black text-slate-900 mb-6 leading-tight">
            ...
            <motion.p variants={fadeInUp} className="text-xl lg:text-2xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Join a team that values excellence, ownership, and continuous growth. Help us connect world-class talent with global opportunities.
            </motion.p>

            <motion.div variants={fadeInUp} className="flex items-center justify-center space-x-8 mb-12">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Remote</div>
                <div className="text-sm text-slate-600">Work Culture</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">4.8/5</div>
                <div className="text-sm text-slate-600">Employee Rating</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
